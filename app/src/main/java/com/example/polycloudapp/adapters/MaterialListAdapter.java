...
public class MaterialListAdapter extends RecyclerView.Adapter<MaterialListAdapter.ViewHolder> {
    ...
    public MaterialListAdapter(Context context, RecyclerView recyclerView, List<MainPolymerNameBean.SpecialPolymerBean> specialPolymerName, String materialTag) {
        mContext = context;
        mRv = recyclerView;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(PolymerListActivity.POLYMER_NAME, mSpecialPolymer.getMethod());
                intent.putExtra(MaterialListActivity.MATERIAL_NAME, mMaterialTag);
